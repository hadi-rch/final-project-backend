...
Route::prefix('v1')->group(function () {
    ...
    Route::get('orders', [OrdersController::class, 'show'])->middleware(['auth:api', 'isverified']);
    Route::apiResource('order', OrdersController::class, ['index','delete'])->middleware(['auth:api', 'isadmin']);
